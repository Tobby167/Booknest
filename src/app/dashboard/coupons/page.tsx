    ...
    return (
      <div className="flex h-[80vh] flex-col items-center justify-center text-center">
        <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm max-w-md w-full">
          ...
          <h2 className="mb-2 text-xl font-black text-slate-900">Coupons are Locked</h2>
          <p className="mb-6 text-sm text-slate-500">
            Upgrade to the Pro or Business plan to create discount codes for your marketing campaigns.
          </p>
